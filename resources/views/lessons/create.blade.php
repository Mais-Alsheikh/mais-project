...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="bg-white rounded-lg shadow-lg p-8">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">إضافة درس جديد</h1>
            <p class="text-gray-600">الدورة: <span class="font-semibold">{{ $course->title }}</span></p>
        </div>
        ...
        <form action="{{ route('lessons.store', $course->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6 hidden" id="pdf-section">
                <label class="block text-gray-700 font-semibold mb-2">رفع ملف PDF</label>
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-500 transition">
                    ...
                    <label for="file" class="cursor-pointer">
                        ...
                        <p class="mt-2 text-sm text-gray-600">اضغط لاختيار ملف PDF</p>
            ...
            <div class="flex gap-4 pt-6 border-t">
                <button type="submit" 
                    class="flex-1 bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition font-semibold shadow-md hover:shadow-lg">
                    إضافة الدرس
                </button>
